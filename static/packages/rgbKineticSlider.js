(function () {
    window.rgbKineticSlider = function (options) {
        ...
        options.transitionScaleAmplitude = options.hasOwnProperty(
            ...
            : 300;
        options.swipeScaleIntensity = options.hasOwnProperty(
            "swipeScaleIntensity"
        )
        ...
        options.textTitleSize = options.hasOwnProperty("textTitleSize")
            ...
            : 125;
        options.mobileTextTitleSize = options.hasOwnProperty(
            "mobileTextTitleSize"
        )
        ...
        options.navTextsRgbIntensity = options.hasOwnProperty(
            ...
            : 10;
        options.imagesRgbIntensity = options.hasOwnProperty(
            "imagesRgbIntensity"
        )
        ...
        function build_scene() {
            ...
            if (
                options.imagesRgbEffect == true &&
                options.cursorImgEffect == true
            ) {
            ...
            if (options.itemsTitles.length > 0) {
                ...
                if (options.textsDisplay == true) {
                    ...
                    for (let i = 0; i < options.itemsTitles.length; i++) {
                        ...
                        // get string after :
                        let fontWeight_1 = options.googleFonts[0]
                            .split(":")
                            .pop();
                    ...
                    if (options.textsSubTitleDisplay == true) {
                        for (let i = 0; i < options.itemsTitles.length; i++) {
                            ...
                            // get string after :
                            let fontWeight_2 = options.googleFonts[1]
                                .split(":")
                                .pop();
                            let word_wrap;
                            ...
                            textTitles2 = new PIXI.Text(
                                options.itemsTitles[i][1],
                                {
                                    fontFamily: font_2,
        ...
        function mainLoop() {
            ...
            if (is_swipping) {
                ...
                if (options.imagesRgbEffect == true) {
                    ...
                    splitRgbImgs.green = [0, 0];
                    splitRgbImgs.blue = [
                        -kineX * options.imagesRgbIntensity,
                        0,
                    ];
                }
            }
        ...
        window.WebFontConfig = {
            ...
            active: function () {
                ...
                imagesLoaded(slideImages, function () {
